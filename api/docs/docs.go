...
const docTemplate = `{
        ...
        "/v1/admin/reconcile-agents": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Override the 30d default for the orphan-delete step. 0 skips deletion (counters-only). Values 1..59 rejected with 400.",
                        "name": "orphan_threshold_secs",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Reconcile completed; errors array is empty",
                        "schema": {
                            "$ref": "#/definitions/store.ReconcileResult"
                        }
                    },
                    "207": {
                        "description": "Reconcile completed with per-agent errors (see errors array)",
                        "schema": {
                            "$ref": "#/definitions/store.ReconcileResult"
                        }
                    },
                    "400": {
                        "description": "orphan_threshold_secs malformed or absurdly small",
                        "schema": {
                            "$ref": "#/definitions/handlers.ErrorResponse"
                        }
                    },
                    ...
                    "500": {
                        "description": "Fatal database error (agent listing or pool exhaustion)",
                        "schema": {
                            "$ref": "#/definitions/handlers.ErrorResponse"
                        }
                    }
        ...
        "/v1/directives/custom": {
            ...
            "delete": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Name prefix to match (e.g. smoke_)",
                        "name": "name_prefix",
                        "in": "query",
                        "required": true
                    }
        ...
        "/v1/fleet": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by D114 agent type: 'coding', 'production', or empty for all",
                        "name": "agent_type",
                        "in": "query"
                    }
                ],
        ...
        "/v1/sessions": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by state (repeatable: active, idle, stale, closed, lost)",
                        "name": "state",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Filter by flavor (repeatable)",
                        "name": "flavor",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Filter to a single agent (D115 UUID; deep-linked from the Fleet agent table and Investigate AGENT facet)",
                        "name": "agent_id",
                        "in": "query"
                    },
                    {
    ...
    "definitions": {
        ...
        "store.SessionListItem": {
            ...
            "properties": {
                "agent_id": {
                    "description": "D115 identity (nullable for lazy-created rows awaiting an\nauthoritative session_start).",
                    "type": "string"
                },
                "agent_name": {
                    "type": "string"
