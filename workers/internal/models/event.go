...
type Event struct {
	...
	TokensCacheRead     pgtype.Int8 `json:"tokens_cache_read" db:"tokens_cache_read"`         // D100
	TokensCacheCreation pgtype.Int8 `json:"tokens_cache_creation" db:"tokens_cache_creation"` // D100
