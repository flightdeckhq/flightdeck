...
const docTemplate = `{
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_handlers.EventResponse"
                        }
                    },
                    "400": {
    ...
    "definitions": {
        "internal_handlers.DirectiveResponse": {
            "type": "object",
            "properties": {
                "action": {
                    "type": "string"
        ...
        "internal_handlers.EventResponse": {
            "type": "object",
            "properties": {
                "attached": {
                    "type": "boolean"
                ...
                "directive": {
                    "$ref": "#/definitions/internal_handlers.DirectiveResponse"
                },
                "status": {
                    "type": "string"
                }
